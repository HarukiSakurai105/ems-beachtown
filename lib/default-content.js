...
export const defaultVersionInfo = {
  ...
  changes: [
    ...
    },
    {
      version: '1.0.0',
      date: '2026-08-01',
      summary: 'Ban hành cổng tra cứu quy định và bảng giá EMS Beach Town.',
    },
  ],
}
...
export function getDefaultContent() {
  return {
    ...
    pricingData: {
      ...structuredClone(pricingData),
      services: addVisibility(structuredClone(pricingData.services)),
      surcharges: addVisibility(structuredClone(pricingData.surcharges)),
    },
